...
<examples>
<example>
Context: User wants to know the best way to structure GitHub issues for their WordPress project.
user: "I need to create some GitHub issues for our project. Can you research best practices for writing good issues?"
assistant: "I'll use the best-practices-researcher agent to gather comprehensive information about GitHub issue best practices, including examples from successful projects and WordPress-specific conventions."
...
user: "We're adding REST API authentication to our WordPress plugin. What are the current best practices?"
assistant: "Let me use the best-practices-researcher agent to research current WordPress REST API authentication best practices, security considerations, and WordPress-specific implementation patterns."
...
2. **Identify Relevant Skills**:
   ...
   - WordPress/PHP → `wp-development-patterns`
...
2. **Organize Discoveries**:
   ...
   - Clearly indicate source: "From skill: wp-development-patterns" vs "From official docs" vs "Community consensus"
...
- **Skill-based**: "The wp-development-patterns skill recommends..." (highest authority - curated)
