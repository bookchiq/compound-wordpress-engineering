...
**Example spawns:**
```
Task general-purpose: "Use the wp-development-patterns skill at ~/.claude/plugins/.../wp-development-patterns. Read SKILL.md and apply it to: [WordPress sections of plan]"
...
**Example filtering:**
```
# Found 15 learning files, plan is about "WordPress object caching"

# SPAWN (likely relevant):
docs/solutions/performance-issues/n-plus-one-queries.md      # tags: [wp-query] ✓
docs/solutions/performance-issues/cache-stampede.md          # tags: [caching, transients] ✓
docs/solutions/configuration-fixes/object-cache-config.md    # tags: [object-cache] ✓

# SKIP (clearly not applicable):
docs/solutions/deployment-issues/server-memory-quota.md      # not about caching
docs/solutions/frontend-issues/block-editor-race.md          # plan is API, not frontend
docs/solutions/authentication-issues/nonce-expiry.md         # plan has no auth
```
