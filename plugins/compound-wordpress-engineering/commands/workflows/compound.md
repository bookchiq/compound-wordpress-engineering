...
- Any code-heavy issue → `wp-php-reviewer` + `code-simplicity-reviewer`
...
Specialized Agent Reviews (Auto-Triggered):
  ...
  ✓ wp-php-reviewer: Code examples meet WordPress standards
...
### Code Quality & Review
- **wp-php-reviewer**: Reviews PHP code examples for WordPress best practices
- **wp-javascript-reviewer**: Reviews JavaScript/block code examples
...
- **wp-hooks-reviewer**: Reviews hook usage in solution code

### Enhancement & Documentation
- **best-practices-researcher**: Enriches solution with industry best practices
- **framework-docs-researcher**: Links to WordPress documentation references
