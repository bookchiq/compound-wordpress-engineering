...
component: [wp_plugin|wp_theme|wp_block|service_object|background_job|database|block_editor|interactivity_api|rest_api|custom_post_type|taxonomy|authentication|wp_cron]
symptoms:
...
- Affected Component: [e.g., "Custom Post Type", "Block editor", "REST API endpoint"]
...
3. What was the underlying issue (API misuse, configuration error, WordPress version issue, etc.)?
