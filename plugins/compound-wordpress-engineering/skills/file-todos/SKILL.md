...
issue_id: "002"
tags: [wordpress, performance, database]
...
```bash
# Search by tag
grep -l "tags:.*wordpress" todos/*.md
...
**WordPress custom post type todos:**
- Custom post type registered via `register_post_type()`
- User-facing feature in the application
- WordPress CRUD operations via WP_Query
